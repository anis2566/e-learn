...
export const EditForm = ({ teacher, id }: Props) => {
    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>Customize teacher information.</CardDescription>
            </CardHeader>
            <CardContent>
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                        <div className="grid md:grid-cols-2 gap-6">
                            ...
                            />
                            <Button type="submit" className="max-w-[130px]" disabled={isPending}>Update</Button>
                        </div>
                    </form>
                </Form>
            </CardContent>
